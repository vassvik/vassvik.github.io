...
In particular, a to find a way to calculate the shape of an interface separating two fluids given a point and a contact angle. Some work-in-progress thing where this is used, without any additional comments (yet): 
