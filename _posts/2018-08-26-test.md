...
A more interactive example can be found in the following Geogebra applet. You can grab two of the circles and move them about, and you can change the radius and sign of each circle using the sliders on the left hand side.
<p align="center">
